...
class TestAuthenticationSecurity:
    ...
    @pytest.mark.asyncio
    @pytest.mark.security
    async def test_token_tampering(self, async_client: AsyncClient):
    ...
    @pytest.mark.asyncio
    @pytest.mark.security
    async def test_authorization_header_case_sensitivity(self, async_client: AsyncClient):
...
class TestInputValidationSecurity:
    ...
    @pytest.mark.asyncio
    @pytest.mark.security
    async def test_xss_prevention_in_messages(self, async_client: AsyncClient, auth_headers, malicious_inputs):
    ...
    @pytest.mark.asyncio
    @pytest.mark.security
    async def test_path_traversal_prevention(self, async_client: AsyncClient, auth_headers):
    ...
    @pytest.mark.asyncio
    @pytest.mark.security
    async def test_large_payload_prevention(self, async_client: AsyncClient, auth_headers):
...
class TestDataValidationSecurity:
    ...
    @pytest.mark.asyncio
    @pytest.mark.security
    async def test_username_validation(self, async_client: AsyncClient):
    ...
    @pytest.mark.asyncio
    @pytest.mark.security
    async def test_message_content_validation(self, async_client: AsyncClient, auth_headers):
